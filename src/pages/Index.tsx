  ...
  return (
    <>
      <Helmet>
        ...
        <title>Friseursalon Berlin | Hair by Aysan</title>
        <meta
          name="description"
          content="Besuche unseren Premium Friseursalon Hair by Aysan in Berlin für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Hair by Aysan | Premium Friseursalon Berlin" />
        <meta
        ...
        <meta name="twitter:title" content="Hair by Aysan | Premium Friseursalon Berlin" />
        <meta
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "sameAs": [
              "https://www.facebook.com/hairbyaysan",
              "https://www.instagram.com/hairbyaysan"
            ]
          })}
        </script>
      </Helmet>
